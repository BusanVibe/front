      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.text}>
            이 약관은 부산스럽다(이하 "회사")가 제공하는 부산 여행 혼잡도 가이드 서비스(이하 "서비스")의 이용과 관련하여 회사와 이용자간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
          </Text>

          <Text style={styles.sectionTitle}>제2조 (정의)</Text>
          <Text style={styles.text}>
            1. "서비스"란 회사가 제공하는 부산 지역 관광지, 맛집, 카페 등의 혼잡도 정보 및 여행 가이드 서비스를 말합니다.{'\n'}
            2. "이용자"란 회사의 약관에 따라 서비스를 이용하는 회원 및 비회원을 말합니다.{'\n'}
            3. "회원"란 회사와 서비스 이용계약을 체결하고 이용자 아이디(ID)를 부여받은 자를 말합니다.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            - 축제 및 이벤트 정보 제공{'\n'}
            - 기타 부산 여행 관련 정보 제공{'\n'}
            2. 회사는 서비스의 내용을 변경할 수 있으며, 변경된 서비스의 내용 및 제공일자를 제공하기 전에 공지합니다.
          </Text>
          ...
          <Text style={styles.text}>
            회사는 관련법이 정하는 바에 따라서 이용자 등록정보를 포함한 이용자의 개인정보를 보호하기 위하여 노력합니다. 이용자의 개인정보보호에 관해서는 관련법 및 회사의 개인정보처리방침이 적용됩니다.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            2. 회사가 제공하는 정보, 자료, 사실의 신뢰도, 정확성 등의 내용에 관하여는 회사가 고의 또는 중대한 과실이 없는 한 회사는 어떠한 책임도 부담하지 아니합니다.
          </Text>
          ...
          <Text style={styles.text}>
            1. 회사와 이용자 간에 발생한 분쟁에 관한 소송은 대한민국의 법을 적용하며, 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.{'\n'}
