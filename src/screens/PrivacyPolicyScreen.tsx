      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.intro}>
            부산스럽다(이하 "회사")는 개인정보보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            2. 서비스 제공{'\n'}
            - 부산 여행 정보 제공, 혼잡도 정보 제공, 맞춤형 콘텐츠 제공, 서비스 이용기록과 접속빈도 분석, 서비스 이용의 유효성 확인, 서비스 개선을 위한 기초 자료 제공을 목적으로 개인정보를 처리합니다.{'\n\n'}
            
            3. 마케팅 및 광고에의 활용{'\n'}
            - 신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재, 서비스의 유효성 확인, 접속빈도 파악 또는 회원의 서비스 이용에 대한 통계를 목적으로 개인정보를 처리합니다.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            - 서버 호스팅: AWS, 클라우드 서비스 제공{'\n'}
            - 데이터 분석: Google Analytics, 서비스 이용 통계 분석{'\n\n'}
          ...
          <Text style={styles.text}>
            ...
            2. 회사는 개인정보처리방침을 개정하는 경우 개정된 개인정보처리방침의 적용일자 및 개정사유를 명시하여 현행 개인정보처리방침과 함께 적용일자 7일 이전부터 공지합니다.
          </Text>
